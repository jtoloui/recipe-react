    ...
    <nav className="bg-white-500 shadow">
      <div className="px-6 py-4 mx-auto">
        <div className="md:flex md:items-center">
          ...
          {/* // menu items */}
          <div
            className={`absolute inset-x-0 flex-1 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white-500  md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto ${
              isBurgerMenuOpen
