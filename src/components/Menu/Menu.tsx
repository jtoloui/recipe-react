				...
				<div className="md:flex md:items-center">
					...
					<div className={`absolute inset-x-0 z-20 flex-1 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white  md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto ${isOpen ? 'shadow translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full'} md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between`}>
						<div className="flex flex-col text-gray-600 capitalize md:flex md:px-16 md:-mx-4 md:flex-row md:items-center w-full">
							{/* <NavLink to="/" className="mt-2 transition-colors duration-300 transform md:mt-0 md:mx-4 text-black">Home</NavLink> */}
							<MenuLink to="/" >Home</MenuLink>
							<MenuLink to="/recipes">My Recipes</MenuLink>
							{/* <NavLink to="/hello" className={({ isActive }) => `mt-2 transition-colors duration-300 transform md:mt-0 md:mx-4 text-black ${isActive ? 'border-b border-green' : ''}`}> My Recipes</NavLink> */}
							{/* <Link to="#" className="mt-2 transition-colors duration-300 transform md:mt-0 md:mx-4 text-black">docs</Link>
							<Link to="#" className="mt-2 transition-colors duration-300 transform md:mt-0 md:mx-4 text-black">support</Link>
							<Link to="#" className="mt-2 transition-colors duration-300 transform md:mt-0 md:mx-4 text-black">blog</Link> */}
